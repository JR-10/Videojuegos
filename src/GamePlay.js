...
var AMOUNT_DIAMONDS = 5;
var AMOUNT_BOOBLES = 5;

/**
 * Inicialización del Videojuego
 * @type {{init: GamePlayManager.init, preload: GamePlayManager.preload, create: GamePlayManager.create, increaseScore: GamePlayManager.increaseScore, showFinalMessage: GamePlayManager.showFinalMessage, onTap: GamePlayManager.onTap, getBoundsDiamond: (function(*): (i.Rectangle|*)), isRectanglesOverlapping: GamePlayManager.isRectanglesOverlapping, isOverlapingOtherDiamond: GamePlayManager.isOverlapingOtherDiamond, getBoundsHorse: (function(): (i.Rectangle|*)), render: GamePlayManager.render, update: GamePlayManager.update}}
 */
GamePlayManager = {

    /**
     * Función para cargar los componentes Iniciales
     */
    init: function() {
    ...
    /**
     * Función Precarga los imagenes y elementos iniciales
     */
    preload: function() {
    ...
    /**
     * Funcion crea las condiciones iniciales para el videojuego
     */
    create: function() {
        ...
        // tipo de fuente para los mesajes
        this.currentScore = 0;
        var style = {
        ...
        // Tiempo duración del videojuego
        this.totalTime = 10;
